...
export class HomeComponent {
  ...
  news_1 = "Fundraiser Bingo for PWD Brgy. Sindalan (PABS)";
  news_2 = "PWSI Hosts Quarterly General Assembly for PWD Community";
  news_3 = "PWSI Celebrates Appreciation Day for Volunteers";
